  ...
  return (
    <section className="relative h-[60vh] text-white">
      <Image
        ...
        data-ai-hint={heroImageData?.imageHint || "restaurant interior"}
        priority
      />
      <div className="absolute inset-0 bg-black/60" />
      <div className="container mx-auto relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
        <h1 className="text-4xl md:text-6xl font-bold font-headline drop-shadow-lg">Experience Dining, Reimagined</h1>
